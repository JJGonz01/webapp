                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group mb-4">
                                ...
                                <input name="bpm" type="number" placeholder="Sensibilidad Pulsaciones (0-100)" class="input-session form-control" id="numberInputBPM" min="0" max="100"></input>
                                <span data-toggle="tooltip" data-html="true" 
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-4">
                                    ...
                                    <input name="movement" type="number" placeholder="Mágnitud del movimiento (0-10)" class="input-session form-control" id="numberInputMove" min="0" max="10"></input>
                                    <span data-toggle="tooltip" data-html="true" 
