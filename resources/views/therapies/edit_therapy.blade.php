...
<form id="form_crear_sesion" action="{{route('therapy_complete_update', ['id' => $therapy -> id])}}" method="POST">
...
<div class="therapy-creation-container">
            ...
            <div class="therapy-input-row">
                <div>
                    <p>NOMBRE</p>
                    <input type="text" id="name_therapy" name="name" value="{{$therapy -> name}}" class="name-therapy-input" placeholder="Nombre de la terapia"></input>
                </div>
                    ...
                    <div class="back-period-creation">
                        <div id="periodo_principal">
                            <div class="therapy-input-row">
                                ...
                                <div>
                                <button id="save_first_period_ther_create" type="button" class="create-medium-button" onclick="saveTemporalPeriod(this)"> Editar bloque</button>
                                </div>
                            </div>
                        </div>
