...
<form id="form_crear_sesion" action="{{route('therapies_create',[], false, true)}}" method="POST">
    ...
    <div class="therapy-creation-container">
        ...
        <div>
            <div class="header-selector">BLOQUES DE ESTUDIO</div>
            ...
            <div class="therapy-creation-row">
                    
                <div class="half-div-short">  
                    ...
                    <div class="row-text-button">
                        ...
                        <button id="period_creation_btn" onclick="showHidePeriodCreation()" type="button" style="width:100%"class="llamative-button">CREAR BLOQUE</button>
                        </div>
                    </div>
                ...
                <div class="half-div-big" style="display:block;" id="period_creation_container">
                    
                    <div class="row-text-button">
                        <p id="periodo_estancia">CREAR BLOQUE DE ESTUDIO</p>
                        <div id="boton_der_periodos">
                        <button id="close_period_creator_container_btn" onclick="closePeriodCreation()" type="button" class="close-button">CANCELAR EDICIÓN</button></div>
                    </div>
